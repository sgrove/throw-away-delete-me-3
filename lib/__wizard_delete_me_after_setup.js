    ...
    ? [
        {
          ...
          execute: async (state) => {
            ...
            console.log('Creating secret: ', 'GITHUB_ORG')
            await fetchOneGraph(
              oneGraphAuth,
              vercelOperationDoc,
              {
                name: fullSecretName('GITHUB_ORG'),
                value: state.vercelProject.link.org,
              },
              'CreateSecretMutation'
            )

            console.log('Creating secret: ', 'GITHUB_REPO')
            await fetchOneGraph(
              oneGraphAuth,
              vercelOperationDoc,
              {
                name: fullSecretName('GITHUB_REPO'),
                value: state.vercelProject.link.repo,
              },
              'CreateSecretMutation'
            )

            console.log('Creating secret: ', 'GIT_PROVIDER')
            await fetchOneGraph(
              oneGraphAuth,
              vercelOperationDoc,
              {
                name: fullSecretName('GIT_PROVIDER'),
          ...
          finishedP: (state) => {
            return (
              ...
              !!findSecretByName(state.secrets, 'GITHUB_ORG') &&
              !!findSecretByName(state.secrets, 'GITHUB_REPO') &&
              !!findSecretByName(state.secrets, 'GIT_PROVIDER')
            )
          },
        },
        {
          ...
          execute: async (state) => {
            ...
            console.log('ONE_GRAPH_APP_ID: ', secret)
            ...
            secret = findSecretByName(state.secrets, 'GITHUB_ORG')
            console.log('GITHUB_ORG: ', secret)
            ...
            secret = findSecretByName(state.secrets, 'GITHUB_REPO')
            console.log('GITHUB_REPO: ', secret)
            ...
            secret = findSecretByName(state.secrets, 'GIT_PROVIDER')
            console.log('GIT_PROVIDER: ', secret)
          ...
          finishedP: () => {
            return (
              ...
              !!findEnvVarByName(state.vercelProject, 'GITHUB_ORG') &&
              !!findEnvVarByName(state.vercelProject, 'GITHUB_REPO') &&
              !!findEnvVarByName(state.vercelProject, 'GIT_PROVIDER')
            )
          },
        },
        {
