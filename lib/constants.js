...
console.log(
  ...
  JSON.stringify(
    process.env,
    {
      NEXT_PUBLIC_ONE_GRAPH_APP_ID: process.env.NEXT_PUBLIC_ONE_GRAPH_APP_ID,
      NEXT_PUBLIC_GITHUB_ORG: process.env.NEXT_PUBLIC_GITHUB_ORG,
      NEXT_PUBLIC_GITHUB_REPO: process.env.NEXT_PUBLIC_GITHUB_REPO,
      NEXT_PUBLIC_GIT_PROVIDER: process.env.NEXT_PUBLIC_GIT_PROVIDER,
      NEXT_PUBLIC_INSTALL_SETUP_WIZARD_HAS_COMPLETED:
        process.env.NEXT_PUBLIC_INSTALL_SETUP_WIZARD_HAS_COMPLETED,
    },
    2
  )
)
